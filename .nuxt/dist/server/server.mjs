...
const _routes = [
  {
    ...
    component: () => import("./assets/about-7a55ad60.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./assets/index-40d0989f.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./assets/error-component-ccab1b3c.js").then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import("./assets/island-renderer-fa516072.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
