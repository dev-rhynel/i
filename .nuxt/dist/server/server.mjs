...
const _routes = [
  {
    ...
    component: () => import("./assets/index-1c48d07a.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./assets/error-component-ceca9bc9.js").then((r) => r.default || r));
